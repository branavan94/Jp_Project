            ...
            <v-card class="mx-auto primary">
              <v-card-text>
                ...
                <v-layout row wrap justify>
                  <v-flex xs12 md3>
                    <div class="undertabdebord caption white--text">Nom du Client</div>
                  </v-flex>
                  <v-flex xs4 sm4 md3>
                    <div class="undertabdebord caption white--text">Accompagnant</div>
                  </v-flex>
                  <v-flex xs4 sm4 md3>
                    <div class="undertabdebord caption white--text">Numéro de téléphone</div>
                  </v-flex>
                  <v-flex xs4 sm4 md3>
                    <div class="undertabdebord caption white--text">Numéro de téléphone</div>
                  </v-flex>
            ...
            <v-card color="white" class=" mx-auto" flat>
              <v-card-text>
                ...
                <v-layout row wrap justify-center>
                  ...
                  <v-flex xs2 sm2 md2>
                    <div class="undertabdebord caption ">Planning à modifier</div>
                  </v-flex>
                  <v-flex xs2 sm2 md2>
